...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 7), // void()(unsigned long long, unsigned int, unsigned int, unsigned int, unsigned int)
/*  1 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 12), // unsigned long long
...
static void _cffi_d_clamp_float(unsigned long long x0, unsigned int x1, unsigned int x2, unsigned int x3, unsigned int x4)
{
  clamp_float(x0, x1, x2, x3, x4);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_clamp_float(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "clamp_float", 5, 5, &arg0, &arg1, &arg2, &arg3, &arg4))
    return NULL;
...
#else
#  define _cffi_f_clamp_float _cffi_d_clamp_float
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "clamp_float", (void *)_cffi_f_clamp_float, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_clamp_float },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__clampfloat(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__clampfloat(void) { return NULL; }
#  else
     init_clampfloat(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__clampfloat(void)
{
  return _cffi_init("_clampfloat", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_clampfloat(void)
{
  _cffi_init("_clampfloat", 0x2601, &_cffi_type_context);
}
#endif
